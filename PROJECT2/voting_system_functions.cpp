...
void AddingNewCandidate(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[], string historyLog[], string historyDate[], int totalHistory)
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void DeletingCandidate(int totalCandidates, string candidateID[], string candidateName[], int isActive[], string historyLog[], string historyDate[], int totalHistory)
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void UpdatingCandidate(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int isActive[], string historyLog[], string historyDate[], int totalHistory)
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void ViewingAllCandidates(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void ViewingVoteCounts(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void SortingByVotes(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void DeclareWinner(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void ViewVotingHistoryLog(int totalHistory, string historyLog[], string historyDate[])
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void ResetElectionData(int &totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[], int &totalVoters, string voterID[], string voterName[], int hasVoted[], string votedFor[], int &totalHistory, string historyLog[], string historyDate[])
{
    cout << "______________________________________________________" << endl;
    cout << "|____________________________________________________|" << endl;
...
void RegisterAsNewVoter(int totalVoters, string voterID[], string voterName[], int hasVoted[], string votedFor[], int &loggedVoterIndex)
{
    cout << "________________________________________________________" << endl;
    cout << "|______________________________________________________|" << endl;
...
void CastYourVote(int totalVoters, string voterID[], string voterName[], int hasVoted[], string votedFor[], int &loggedVoterIndex, int electionOpen, int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "________________________________________________________" << endl;
    cout << "|______________________________________________________|" << endl;
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                for (int i = 0; i < totalCandidates; i++)
                {
                    if (candidateID[i] == voteForID && isActive[i] == 1)
                        candIdx = i;
                }
...
void SearchCandidatesByName(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "________________________________________________________" << endl;
    cout << "|______________________________________________________|" << endl;
    ...
    for (int i = 0; i < totalCandidates; i++)
    {
        if (isActive[i] == 1)
        {
            ...
            for (int k = 0; k <= nLen - sLen; k++)
            {
                ...
                {
                    if (candidateName[i][k + m] != searchTerm[m])
                        sub = 0;
                }
                if (sub == 1)
                    match = 1;
...
void ViewCurrentStandings(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "________________________________________________________" << endl;
    cout << "|______________________________________________________|" << endl;
...
void ViewCandidatesAlphabetically(int totalCandidates, string candidateID[], string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "________________________________________________________" << endl;
    cout << "|______________________________________________________|" << endl;
...
void CheckYourVoteStatus(int totalVoters, string voterID[], string voterName[], int hasVoted[], string votedFor[])
{
    cout << "________________________________________________________" << endl;
    cout << "|______________________________________________________|" << endl;
...
void DisplayPartyWiseSummary(int totalCandidates, string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "________________________________________________________" << endl;
    cout << "|______________________________________________________|" << endl;
    ...
    for (int i = 0; i < totalCandidates; i++)
    {
        if (isActive[i] == 1)
        {
            ...
            {
                if (uniqueParties[p] == partyName[i])
                    pFound = p;
            }
...
void ViewWinnerAnnouncement(int totalCandidates, string candidateName[], string partyName[], int voteCount[], int isActive[])
{
    cout << "________________________________________________________" << endl;
    cout << "|______________________________________________________|" << endl;
            ...
            for (adminAttempts = 0; adminAttempts < 3; adminAttempts++)
            {
                ...
                if (adminUsername == "admin" && adminPassword == "1234")
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            system("cls");
                            AddingNewCandidate(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive, historyLog, historyDate, totalHistory);
                        ...
                        {
                            system("cls");
                            DeletingCandidate(totalCandidates, candidateID, candidateName, isActive, historyLog, historyDate, totalHistory);
                            cout << "Press any key to return to the admin menu..." << endl;
                            getch();
                        }
                        // ============================================================
                        ...
                        {
                            system("cls");
                            UpdatingCandidate(totalCandidates, candidateID, candidateName, partyName, isActive, historyLog, historyDate, totalHistory);
                            cout << "Press any key to return to the admin menu..." << endl;
                            getch();
                        }
                        // ============================================================
                        ...
                        {
                            system("cls");
                            ViewingAllCandidates(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the admin menu..." << endl;
                            getch();
                        }
                        // ============================================================
                        ...
                        {
                            system("cls");
                            ViewingVoteCounts(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the admin menu..." << endl;
                            getch();
                        }
                        // ============================================================
                        ...
                        {
                            system("cls");
                            SortingByVotes(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the admin menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            DeclareWinner(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the admin menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            ViewVotingHistoryLog(totalHistory, historyLog, historyDate);
                            cout << "Press any key to return to the admin menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            ResetElectionData(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive, totalVoters, voterID, voterName, hasVoted, votedFor, totalHistory, historyLog, historyDate);
                            cout << "Press any key to return to the admin menu..." << endl;
                            getch();
                        }
            ...
            for (voterAttempts = 0; voterAttempts < 3; voterAttempts++)
            {
                ...
                if (voterUsername == "voter" && voterPassword == "9876")
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            system("cls");
                            RegisterAsNewVoter(totalVoters, voterID, voterName, hasVoted, votedFor, loggedVoterIndex);
                        ...
                        {
                            system("cls");
                            CastYourVote(totalVoters, voterID, voterName, hasVoted, votedFor, loggedVoterIndex, electionOpen, totalCandidates, candidateID, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the voter menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            SearchCandidatesByName(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the voter menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            ViewCurrentStandings(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the voter menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            ViewCandidatesAlphabetically(totalCandidates, candidateID, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the voter menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            CheckYourVoteStatus(totalVoters, voterID, voterName, hasVoted, votedFor);
                            cout << "Press any key to return to the voter menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            DisplayPartyWiseSummary(totalCandidates, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the voter menu..." << endl;
                            getch();
                        }
                        ...
                        {
                            system("cls");
                            ViewWinnerAnnouncement(totalCandidates, candidateName, partyName, voteCount, isActive);
                            cout << "Press any key to return to the voter menu..." << endl;
                            getch();
                        }
